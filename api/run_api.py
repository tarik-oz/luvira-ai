...
def print_startup_info():
    ...
    print()
    print("Health Check:")
    print(f"   • Status: http://{API_CONFIG['host']}:{API_CONFIG['port']}/")
    print(f"   • Health: http://{API_CONFIG['host']}:{API_CONFIG['port']}/health")
    print()
    print("Model Endpoints:")
    print(f"   • Model Info: http://{API_CONFIG['host']}:{API_CONFIG['port']}/model-info")
    print(f"   • Predict Mask (File): http://{API_CONFIG['host']}:{API_CONFIG['port']}/predict-mask")
    print(f"   • Predict Mask (JSON): http://{API_CONFIG['host']}:{API_CONFIG['port']}/predict-mask-json")
    print()
