...
allImagesNP = np.load(
    "C:/Users/Tarik/Desktop/U-Net_conda/data/Unet_Train_Hair_Images.npy"
)
maskImagesNP = np.load(
    "C:/Users/Tarik/Desktop/U-Net_conda/data/Unet_Train_Hair_Masks.npy"
)

print("start loading the validate data ....... ")

allValidateImagesNP = np.load(
    "C:/Users/Tarik/Desktop/U-Net_conda/data/Unet_Valid_Hair_Images.npy"
)
maskValidateImagesNP = np.load(
    "C:/Users/Tarik/Desktop/U-Net_conda/data/Unet_Valid_Hair_Masks.npy"
)
...
best_model_file = "C:/Users/Tarik/Desktop/U-Net_conda/data/Hair-Unet.h5"
