...
<template>
  ...
  <div class="mx-auto w-full max-w-7xl">
    <div class="border-base-content border-top border-t opacity-20"></div>
  </div>
  <footer class="py-3 md:py-4 lg:py-6">
    <div
      class="mx-auto flex max-w-7xl flex-row flex-wrap items-center justify-between gap-x-3 gap-y-2 px-4 text-xs md:flex-nowrap md:text-sm"
    >
      <!-- Left: Copyright -->
      <div class="text-base-content/60 text-xs font-medium md:text-sm lg:text-base">
        {{ t('footer.copyright') }}
      </div>
      <!-- Right: Social links -->
      <div class="flex items-center space-x-3 md:space-x-3 lg:space-x-4">
        <a
